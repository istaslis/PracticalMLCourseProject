...
which identifies the classes with very high accuracy. Unfortunately, I don't have time to do the cross-validation... Which is not actually necessary: I ran this several times and got the same result.:) The testing dataset:
